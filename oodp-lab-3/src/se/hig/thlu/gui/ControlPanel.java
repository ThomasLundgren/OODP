	...
	private void configureComponents() {
		...
		addAlarmButton.addActionListener(buttonClick -> {
			...
			if (result == JOptionPane.OK_OPTION) {
				...
				List<ClockController.AlarmActions> alarmActions = new LinkedList<ClockController.AlarmActions>();
				if (alarmStr.equals(BLINKING)) {
					alarmActions.add(ClockController.AlarmActions.BLINKING);
				} else if (alarmStr.equals(SOUND)) {
					System.out.println("SoundAlarmAction added to alarm");
					alarmActions.add(ClockController.AlarmActions.SOUND);
